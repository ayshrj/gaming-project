...
function RandomTablerSVG() {
  const randomIndex = Math.floor(Math.random() * TablerIconName.length);
  return <i className={`ti ti-${TablerIconName[randomIndex]}`} />;
}

export default RandomTablerSVG;
